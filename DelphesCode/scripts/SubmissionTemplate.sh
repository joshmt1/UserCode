...
outputdir=/eos/cms/store/user/joshmt/upgrade/v10-PUID/XXXOUTPATHXXX
...
./FlatTree "root://eoscms.cern.ch/XXXEOSPATHXXX/XXXSAMPLEIDXXX/*.root" -O ${workdir}/${outfilename} -N IJOB NJOB -pujetid
ls -l ${workdir}/*.root
